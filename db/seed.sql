...
-- ============================================================
-- Texts
-- Five texts below reference real files in frontend/img/uploads/ so
-- the demo shows real covers, not just placeholders:
--   28e7f4c22b28275d.webp   -> O Silêncio das Estrelas
--   fd962866a992904e.jpg    -> Cartas que Nunca Enviei
--   44b538226f5a7041.jpg    -> A Última Colheita
--   6564b30679a4245e.webp   -> Sonata em Ré Menor
--   5db956a3391070eb.webp   -> El Eco de la Montaña
-- These five files are NOT tracked by git (see .gitignore, which
-- ignores everything under frontend/img/uploads/ except .gitkeep)
-- and must be copied into frontend/img/uploads/ by hand on any
-- machine that reloads this seed. Every other text keeps cover_image
-- NULL on purpose, and the catalog/home cards already render a
-- placeholder for NULL covers.
--
-- favorites is seeded with hand-picked counts (always below the row's
-- read_count) so the "Most favourited" carousel on home.php has real
-- data and ranks differently from "Most viewed".
-- ============================================================

INSERT INTO texts (author_id, title, body, description, category, cover_image, visibility, language, read_count, favorites) VALUES
...
'poetry', '28e7f4c22b28275d.webp', 'public', 'ptbr', 340, 210);
...
'book', 'fd962866a992904e.jpg', 'public', 'ptbr', 128, 64);
...
'story', '44b538226f5a7041.jpg', 'public', 'ptbr', 512, 158);
...
'poetry', '6564b30679a4245e.webp', 'public', 'ptbr', 76, 41);
...
'story', '5db956a3391070eb.webp', 'public', 'es', 167, 168);
...
'story', NULL, 'public', 'ptbr', 634, 122);
